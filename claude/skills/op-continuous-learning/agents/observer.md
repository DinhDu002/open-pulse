...
Reads events from SQLite via `cl-export-events.js` for the project specified by `PROJECT_ROOT`.
...
- Project: `~/Workspace/open-pulse/projects/<project-hash>/instincts/personal/`
- Global: `~/Workspace/open-pulse/instincts/personal/` (for universal patterns)
